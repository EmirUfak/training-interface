...
class BaseTrainingTab(ctk.CTkFrame):
    ...
    def run_training_loop(self, models, X_train, X_test, y_train, y_test, vectorizer=None, apply_scaling=False, extra_data=None, optimize=False, optimize_strategy="all"):
        ...
        manager.run_training_loop(models, X_train, X_test, y_train, y_test, vectorizer, apply_scaling, extra_data, optimize, optimize_strategy)

    def stop_training(self):
        self.stop_training_flag = True
        if hasattr(self, 'btn_train'):
            self.btn_train.configure(state="disabled", text=self.tr("btn_stopping"))
